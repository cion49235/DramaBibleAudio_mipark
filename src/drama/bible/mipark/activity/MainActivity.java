package drama.bible.mipark.activity;
...
import drama.bible.mipark.R;
import drama.bible.mipark.adapter.MainAdapter;
import drama.bible.mipark.data.Favorite_DBopenHelper;
import drama.bible.mipark.data.Main_Data;
import drama.bible.mipark.data.Pause_DBOpenHelper;
import drama.bible.mipark.mediaplayer.ContinueMediaPlayer;
import drama.bible.mipark.util.Crypto;
import drama.bible.mipark.util.HangulUtil;
import drama.bible.mipark.util.PreferenceUtil;
import drama.bible.mipark.util.Utils;
import drama.bible.mipark.youtubeplayer.CustomYoutubePlayer;
...
public class MainActivity extends Activity implements OnItemClickListener, OnClickListener, OnScrollListener, AdViewListener, CustomPopupListener, InterstitialAdListener{
	...
	AdMixerManager.getInstance().setAdapterDefaultAppCode(AdAdapter.ADAPTER_ADMIXER, "uvtzdxs4");
	AdMixerManager.getInstance().setAdapterDefaultAppCode(AdAdapter.ADAPTER_ADMOB, "ca-app-pub-4637651494513698/6722548340");
	AdMixerManager.getInstance().setAdapterDefaultAppCode(AdAdapter.ADAPTER_ADMOB_FULL, "ca-app-pub-4637651494513698/2660192014");
	
//	  Custom Popup 시작
	CustomPopup.setCustomPopupListener(this);
	CustomPopup.startCustomPopup(this, "uvtzdxs4");
...
//		admobNative.destroy();
	...
	private void init_admob_naive(){
		...
		admobNative.setAdUnitId("ca-app-pub-4637651494513698/6231593753");
		nativeContainer.addView(admobNative);
		admobNative.loadAd(adRequest);
	}
	
	public void addBannerView() {
    	AdInfo adInfo = new AdInfo("uvtzdxs4");
